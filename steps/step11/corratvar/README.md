...
We are gathering here the results coming from Correlation study for all ratio variables (page 162) - -> (https://github.com/MoiraCorp/DLMM-IRating-in-R/tree/main/steps/step8/allvar) <br>
